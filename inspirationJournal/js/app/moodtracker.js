...
function renderTrackerInput(completed=false){
    ...
    if(completed === false){
        ...
        <img class="mood-btn" data-mood="1" id="down" src="/wdd330/inspirationJournal/img/icons/down.svg">
        <img class="mood-btn" data-mood="2" id="neutral" src="/wdd330/inspirationJournal/img/icons/neutral.svg">
        <img class="mood-btn" data-mood="3" id="good" src="/wdd330/inspirationJournal/img/icons/good.svg">
        </div>
        `;
